...
const AmountSection = () => {
  return (
    <div className="col-span-12 text-lg px-8  pt-[3rem] grid grid-cols-12  sm:w-full sm:mx-auto">
      ...
      <div className="col-span-12 gap-y-4 px-[2rem] pb-[2rem] pt-[6rem] grid grid-cols-12 sm:grid-cols-4">
        <div className="col-span-12  gap-y-2 flex flex-col">
